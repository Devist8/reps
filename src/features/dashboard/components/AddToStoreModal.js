...
import { addToStore, updateStoreSections } from "../features/store/actions";
...
const useStyles = makeStyles((theme) => ({
    ...
    contentText: { margin: "5px", width: "100%", textAlign: "center" },
}));
...
export const AddToStoreModal = (props) => {
    ...
    return (
        ...
        >
            ...
            >
                <Grid item xs={12} className={classes.centerX}>
                    <IconButton
                        onClick={() => {
                            if (selectedItem !== 0) {
                                source === "collection"
